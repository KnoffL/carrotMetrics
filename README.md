...
So far, the project fetches data from a csv file or returns an empty data frame if the file does not exist. There is also a function (addSupermarket()) to add and save new data to the data frame.
